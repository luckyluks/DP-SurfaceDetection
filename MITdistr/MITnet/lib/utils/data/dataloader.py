...
class DataLoaderIter(object):
    ...
    def __init__(self, loader):
        ...
        if self.num_workers > 0:
            ...
            'venv/lib/python3.7/site-packages/torch/utils/data/_utils/signal_handling.py'
            torch.utils.data._utils.signal_handling._set_worker_pids(id(self), tuple(w.pid for w in self.workers))
