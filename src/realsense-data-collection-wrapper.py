...
def main():
    ...
    for run_index in range(args.runs):
        ...
        if run_index==0:
            record_runs(is_test_run=False, is_long_warmup_run=True, clip_length=args.clip, warmup_length=args.warmup, fps=args.fps, directory=args.directory)
        else:
            record_runs(is_test_run=False, is_long_warmup_run=False, clip_length=args.clip, warmup_length=args.warmup, fps=args.fps, directory=args.directory)
