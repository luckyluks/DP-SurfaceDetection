...
#
# groundTruth = y_train[ix].squeeze()
...
callbacks = [
    ...
    ModelCheckpoint('unetTFchk.h5', verbose=1, save_best_only=True, save_weights_only=True)
]
...
# plt.ylabel("log_loss")
# plt.legend();
print('loss {} val loss {}'.format(results.history["loss"][-1],results.history["val_loss"][0]))
